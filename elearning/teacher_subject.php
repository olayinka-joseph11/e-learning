    ...
    <div class="container">
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li   class="active"><a href="teacher_subject.php"><i class="icon-file-alt icon-large"></i>&nbsp;courses
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
            ...
            <div class="span9">
                ...
                <a href="teacher_add_subject.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add course</a>
                <br>
                <br>
                <div class="hero-unit-3">
