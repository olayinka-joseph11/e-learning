...
<body>
    ...
    <div class="container">
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li   class="active">
                            <a href="teacher_class.php"><i class="icon-group icon-large"></i>&nbsp;Material
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
                        <li><a href="teacher_subject.php"><i class="icon-file-alt icon-large"></i>&nbsp;Course
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
            ...
            <div class="span9">
                <a href="teacher_add_class.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Course</a>
                <br></br>
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <strong><i class="icon-user icon-large"></i>&nbsp;Material Table</strong>
                        </div>
                        <thead>
                            <tr>
